<template>
  <div class="page-container king-setup">
    <div class="content-container setup-container">
      <SetupHeader 
        :title="t('kingGame.title')" 
        @back="goToGameSelection" 
      />

      <!-- About King section -->
      <div class="info-section card">
        <h1 class="scribble-underline">{{ t('kingRules.about') }}</h1>
        <ul>
          <li>{{ t('kingRules.rule1') }}</li>
          <li>{{ t('kingRules.rule2') }}</li>
          <li>{{ t('kingRules.rule3') }}</li>
          <li>{{ t('kingRules.rule4') }}</li>
          <li>{{ t('kingRules.rule5') }}</li>
          <li>{{ t('kingRules.rule6') }}</li>
          <li>{{ t('kingRules.rule7') }}</li>
          <li>{{ t('kingRules.rule8') }}</li>
        </ul>
      </div>
...
const { t } = useI18n()
const gameConfig = getGameConfig('king')
